...
public partial class CustomLanguageLexer : Lexer {
	...
	public static readonly string[] ruleNames = {
		...
		"DECREMENT", "SMALLER_EQ", "GREATER_EQ", "SAME", "DIFF", "SMALLER", "GREATER", 
		"AND", "NOT", "OR", "EQADD", "EQSUB", "EQMUL", "EQDIV", "EQMOD", "EQUAL", 
		"MUL", "DIV", "ADD", "SUB", "MOD", "NAME", "INTEGER_VALUE", "FLOAT_VALUE", 
	...
	private static int[] _serializedATN = {
		...
		16,1,16,1,16,1,16,1,17,1,17,1,17,1,18,1,18,1,18,1,19,1,19,1,19,1,20,1,
		...
		36,1,37,1,37,1,38,1,38,1,39,1,39,5,39,227,8,39,10,39,12,39,230,9,39,1,
		...
		176,1,0,0,0,43,179,1,0,0,0,45,182,1,0,0,0,47,185,1,0,0,0,49,187,1,0,0,
		0,51,189,1,0,0,0,53,192,1,0,0,0,55,194,1,0,0,0,57,197,1,0,0,0,59,200,1,
		0,0,0,61,203,1,0,0,0,63,206,1,0,0,0,65,209,1,0,0,0,67,212,1,0,0,0,69,214,
		...
		45,0,0,171,172,5,45,0,0,172,38,1,0,0,0,173,174,5,60,0,0,174,175,5,61,0,
		0,175,40,1,0,0,0,176,177,5,62,0,0,177,178,5,61,0,0,178,42,1,0,0,0,179,
		180,5,61,0,0,180,181,5,61,0,0,181,44,1,0,0,0,182,183,5,33,0,0,183,184,
		5,61,0,0,184,46,1,0,0,0,185,186,5,60,0,0,186,48,1,0,0,0,187,188,5,62,0,
		0,188,50,1,0,0,0,189,190,5,38,0,0,190,191,5,38,0,0,191,52,1,0,0,0,192,
		193,5,33,0,0,193,54,1,0,0,0,194,195,5,124,0,0,195,196,5,124,0,0,196,56,
		1,0,0,0,197,198,5,43,0,0,198,199,5,61,0,0,199,58,1,0,0,0,200,201,5,45,
		0,0,201,202,5,61,0,0,202,60,1,0,0,0,203,204,5,42,0,0,204,205,5,61,0,0,
		205,62,1,0,0,0,206,207,5,47,0,0,207,208,5,61,0,0,208,64,1,0,0,0,209,210,
		5,37,0,0,210,211,5,61,0,0,211,66,1,0,0,0,212,213,5,61,0,0,213,68,1,0,0,
		0,214,215,5,42,0,0,215,70,1,0,0,0,216,217,5,47,0,0,217,72,1,0,0,0,218,
		219,5,43,0,0,219,74,1,0,0,0,220,221,5,45,0,0,221,76,1,0,0,0,222,223,5,
		37,0,0,223,78,1,0,0,0,224,228,7,0,0,0,225,227,7,1,0,0,226,225,1,0,0,0,
		227,230,1,0,0,0,228,226,1,0,0,0,228,229,1,0,0,0,229,80,1,0,0,0,230,228,
		1,0,0,0,231,233,7,2,0,0,232,231,1,0,0,0,232,233,1,0,0,0,233,235,1,0,0,
		0,234,236,7,3,0,0,235,234,1,0,0,0,236,237,1,0,0,0,237,235,1,0,0,0,237,
		238,1,0,0,0,238,82,1,0,0,0,239,241,7,2,0,0,240,239,1,0,0,0,240,241,1,0,
		0,0,241,243,1,0,0,0,242,244,7,3,0,0,243,242,1,0,0,0,244,245,1,0,0,0,245,
		243,1,0,0,0,245,246,1,0,0,0,246,247,1,0,0,0,247,249,5,46,0,0,248,250,7,
		3,0,0,249,248,1,0,0,0,250,251,1,0,0,0,251,249,1,0,0,0,251,252,1,0,0,0,
		252,84,1,0,0,0,253,254,5,34,0,0,254,263,5,34,0,0,255,257,5,34,0,0,256,
		258,9,0,0,0,257,256,1,0,0,0,258,259,1,0,0,0,259,260,1,0,0,0,259,257,1,
		0,0,0,260,261,1,0,0,0,261,263,5,34,0,0,262,253,1,0,0,0,262,255,1,0,0,0,
		263,86,1,0,0,0,264,265,5,47,0,0,265,266,5,42,0,0,266,268,1,0,0,0,267,269,
		9,0,0,0,268,267,1,0,0,0,269,270,1,0,0,0,270,271,1,0,0,0,270,268,1,0,0,
		0,271,274,1,0,0,0,272,273,5,42,0,0,273,275,5,47,0,0,274,272,1,0,0,0,275,
		276,1,0,0,0,276,274,1,0,0,0,276,277,1,0,0,0,277,278,1,0,0,0,278,279,6,
		43,0,0,279,88,1,0,0,0,280,281,5,47,0,0,281,282,5,47,0,0,282,284,1,0,0,
		0,283,285,9,0,0,0,284,283,1,0,0,0,285,286,1,0,0,0,286,287,1,0,0,0,286,
		284,1,0,0,0,287,288,1,0,0,0,288,289,7,4,0,0,289,290,1,0,0,0,290,291,6,
		44,0,0,291,90,1,0,0,0,292,294,7,5,0,0,293,292,1,0,0,0,294,295,1,0,0,0,
		295,293,1,0,0,0,295,296,1,0,0,0,296,297,1,0,0,0,297,298,6,45,0,0,298,92,
		1,0,0,0,13,0,228,232,237,240,245,251,259,262,270,276,286,295,1,6,0,0
	};
